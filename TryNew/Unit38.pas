...
var
  Form38: TForm38;
   k:integer;
   nazv,question,otv1,otv2,otv3,otv4,otv5,opisan :string;
  kolvo, Type_otvet, type_obr:integer;
   nomer:Integer;
implementation

uses Unit35, Unit2, Unit39, Unit34, Unit37, Unit55, Unit56, Unit57, Unit58,
  Unit33, Unit32, Unit31, Unit30, Unit29, Unit40, Unit41, Unit27,
  Unit8, Unit28, Unit88, Test;
...
Form39.Label2.Caption:=Form39.Label2.Caption+nazv;
...
1:begin
     ...
     Form37.Caption:='Вопрос '+ '1' + ' из ' +IntToStr(kolvo);
...
2:begin
     ...
     Form55.Caption:='Вопрос '+ '1' + ' из ' +IntToStr(kolvo);
...
3:begin
     ...
     Form56.opis:=opisan;
     Form56.Caption:='Вопрос '+ '1' + ' из ' +IntToStr(kolvo);
...
4:begin
     ...
     Form57.opis:=opisan;
     Form57.Caption:='Вопрос '+ '1' + ' из ' +IntToStr(kolvo);
     Form57.Question.Caption:=question;
     //Form57.Label6.Caption:=Form2.Label3.Caption;
     Form38.Hide;
     Form57.show;
  end;
5:begin
     ...
     Form58.Caption:='Вопрос '+ '1' + ' из ' +IntToStr(kolvo);
...
6:begin
 ...
 7:begin
     ...
     Form88.opis:=opisan;
     Form88.Caption:='Вопрос '+ '1' + ' из ' +IntToStr(kolvo);
...
begin
   ...
   try
   MyModule.ADOQuery2.SQL.Clear;
    MyModule.ADOQuery2.SQL.Add('SELECT * FROM Test');
