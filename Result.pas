...
implementation
 uses Unit20, Unit10, Unit13, Unit17, Unit19, Unit23, Unit2, Result_Graph,
  Unit27,Unit35;
{$R *.dfm}
...
begin
  ...
  sum3:=0;
  Label2.Visible:=true;
  Label2.Caption:='Данный тест прошли:';
  stroka:='';
  stroka:=QuotedStr(ComboBox1.Text);
  ADOQuery1.SQL.Clear;
  squery:= 'SELECT * FROM Result WHERE Name_test='+QuotedStr(ComboBox1.Text);
