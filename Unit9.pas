...
try
    if Application.MessageBox('Удалить?','Удаление',MB_YESNO)=IDYES then
     begin
        ADOQuery2.SQL.Clear;
       squery:='Delete From Test_Information Where N_testa=' + QuotedStr(DBGrid1.Fields[0].AsString);
       ADOQuery2.SQL.Text:= squery;
       ADOQuery2.ExecSQL;


       ADOQuery2.SQL.Clear;
       squery:='Delete From Test_App Where Name_Test=' + QuotedStr(DBGrid1.Fields[1].AsString);
       ADOQuery2.SQL.Text:= squery;
       ADOQuery2.ExecSQL;
