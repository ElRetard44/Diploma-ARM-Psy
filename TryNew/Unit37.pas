...
uses Unit35, Unit34, Unit39, Unit2, Unit38, Unit28, Result, Unit11;
 ...
 begin
    ...
    with MyModule.ADOQuery2 do
     begin
       ...
       Caption:='Вопрос '+IntToStr(i)+' из '+IntToStr(Form37.N);
       ...
       begin
        with MyModule.ADOQuery2 do
          begin
             Close;
             SQL.clear;
             squery:= 'Select bal1,bal2 from Test_Information where N_1='+IntToStr(metka+i-1);
             SQL.Text:= squery;
             open;
             bal1:=MyModule.ADOQuery2.Fields[0].AsInteger;
             bal2:=MyModule.ADOQuery2.Fields[1].AsInteger;
