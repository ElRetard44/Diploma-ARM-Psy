...
uses Unit2, Unit29, Unit30, Unit31, Unit40, Unit42, Unit44, Unit47,
...
try
  ...
  ADOQuery1.SQL.Clear;
  squery:= 'Delete From Result Where N_vlast=' + IntTostr(N_vlast);
  ADOQuery1.SQL.Text:= squery;
  ADOQuery1.ExecSQL;

  ADOQuery1.SQL.Clear;
  squery:= 'Delete From Intermediate_result Where N_vlast=' + IntTostr(N_vlast);
  ADOQuery1.SQL.Text:= squery;
  ADOQuery1.ExecSQL;
